...
export function IMUDisplay({ hubData, className = "" }: IMUDisplayProps) {
  ...
  const calculateBatteryPercentage = (voltageMillivolts: number): number => {
    ...
    const percentage =
      10 +
      ((voltageMillivolts - MIN_SAFE_VOLTAGE) /
        (MAX_VOLTAGE - MIN_SAFE_VOLTAGE)) *
        90;
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      ...
      {hubData.battery &&
        (() => {
          const voltageVolts = hubData.battery.voltage
          ...
          return (
            <div
              className={`rounded-lg border p-4 shadow-sm ${batteryStatus.bgColor} dark:${batteryStatus.bgColor.replace("bg-", "bg-").replace("-50", "-900")} ${batteryStatus.borderColor} dark:${batteryStatus.borderColor.replace("border-", "border-").replace("-200", "-700")}`}
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div
                  className={`text-xs font-medium px-2 py-1 rounded-full ${batteryStatus.color} bg-white dark:bg-gray-800 bg-opacity-50 dark:bg-opacity-50`}
                >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
          <div className="text-center mb-3">
            ...
            <div className="relative w-24 h-24 mx-auto">
              ...
              {/* Cardinal directions */}
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1 text-xs font-bold text-gray-600 dark:text-gray-400">
                N
              </div>
              <div className="absolute right-0 top-1/2 transform translate-x-1 -translate-y-1/2 text-xs font-bold text-gray-600 dark:text-gray-400">
                E
              </div>
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1 text-xs font-bold text-gray-600 dark:text-gray-400">
                S
              </div>
              <div className="absolute left-0 top-1/2 transform -translate-x-1 -translate-y-1/2 text-xs font-bold text-gray-600 dark:text-gray-400">
                W
              </div>
              ...
              <div
                ...
                style={{
                  transform: `rotate(${normalizeHeading(hubData.imu.heading || 0)}deg)`,
                }}
              >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="text-center">
              ...
              <div
                className={`font-mono font-bold ${getAccelerationColor(hubData.imu.acceleration?.[0] || 0)}`}
              >
                {formatValue(
            ...
            <div className="text-center">
              ...
              <div
                className={`font-mono font-bold ${getAccelerationColor(hubData.imu.acceleration?.[1] || 0)}`}
              >
                {formatValue(
            ...
            <div className="text-center">
              ...
              <div
                className={`font-mono font-bold ${getAccelerationColor(hubData.imu.acceleration?.[2] || 0)}`}
              >
                {formatValue(
      ...
      {hubData.gyro && (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {hubData.gyro.speed !== undefined &&
              hubData.gyro.speed !== null && (
                <div className="text-center">
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">
                    Speed
                  </div>
